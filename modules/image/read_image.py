...
def get_image(experimental_drop: ExperimentalDrop,
...
def save_image(experimental_drop: ExperimentalDrop, experimental_setup: ExperimentalSetup, frame_number: int) -> None:
...
def import_from_source(experimental_drop: ExperimentalDrop, experimental_setup: ExperimentalSetup, frame_number: int) -> None:
...
def image_from_harddrive(experimental_drop: ExperimentalDrop, experimental_setup: ExperimentalSetup, frame_number: int) -> None:
...
def get_import_filename(experimental_setup: ExperimentalSetup, frame_number: int) -> str:
