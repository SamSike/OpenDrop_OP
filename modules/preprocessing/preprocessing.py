...
def auto_crop(img: np.ndarray, low=50, high=150, aperture_size=3, verbose=0):  # DS 08/06/23
    '''
...
def extract_edges_cv(img: np.ndarray, threshold_val=None, return_threshold_value=False, display=False):
    '''
