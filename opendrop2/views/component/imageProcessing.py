...
from opendrop2.modules.core.classes import ExperimentalDrop, ExperimentalSetup
...
from opendrop2.utils.image_handler import ImageHandler

from PIL import Image  # , ImageTk
import customtkinter as ctk
import os

# from opendrop2.modules.image.select_regions import set_drop_region,set_surface_line, correct_tilt,user_roi
# from opendrop2.modules.core.classes import ExperimentalSetup, ExperimentalDrop, DropData, Tolerances
...
class ImageApp(ctk.CTkFrame):
    def __init__(
        ...
        # Assuming main_frame is in row 0 now (see below)
    ...
    def initialize_image_display(self, frame):
        ...
        # Fill the top row of main_frame
        ...
        # Row for navigation (fixed height)
