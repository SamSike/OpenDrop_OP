from opendrop2.modules.fitting.polynomial_fit import (
    cluster_optics,
    distance1,
    optimized_path,
    prepare_hydrophobic,
...
@patch("opendrop2.modules.fitting.polynomial_fit.plt.show")
...
@patch("opendrop2.modules.fitting.polynomial_fit.cv2.cvtColor")
@patch("opendrop2.modules.fitting.polynomial_fit.cv2.threshold")
@patch("opendrop2.modules.fitting.polynomial_fit.cv2.findContours")
...
@patch("opendrop2.modules.fitting.polynomial_fit.extract_edges_CV")
@patch("opendrop2.modules.fitting.polynomial_fit.prepare_hydrophobic")
