from opendrop2.modules.fitting.BA_fit import (
    cluster_optics,
    distance1,
    dist,
    optimized_path,
...
@patch("opendrop2.modules.fitting.BA_fit.plt.show")
...
@patch("opendrop2.modules.fitting.BA_fit.solve_ivp")
...
@patch("opendrop2.modules.fitting.BA_fit.opt.minimize")
...
@patch("opendrop2.modules.fitting.BA_fit.plt.show")
@patch("opendrop2.modules.fitting.BA_fit.fit_circle", return_value={"x": [0, 0, 1], "fun": 0.1})
@patch("opendrop2.modules.fitting.BA_fit.find_intersection", return_value=(0.5, 0.5))
@patch("opendrop2.modules.fitting.BA_fit.generate_circle_vectors", return_value=([1, 0], [0, 1]))
@patch("opendrop2.modules.fitting.BA_fit.calculate_angle", return_value=90)
@patch("opendrop2.modules.fitting.BA_fit.fit_bashforth_adams", return_value=MagicMock(x=[1, 1]))
@patch(
    "opendrop2.modules.fitting.BA_fit.sim_bashforth_adams",
