#!/usr/bin/env python
# coding=utf-8
from opendrop2.modules.core.classes import ExperimentalDrop
...
def perform_fits(
    ...
    if tangent == True:
        from opendrop2.modules.fitting.polynomial_fit import polynomial_fit
    ...
    if circle == True:
        from opendrop2.modules.fitting.circular_fit import circular_fit
