...
from opendrop2.modules.preprocessing.preprocessing import (
    prepare_hydrophobic,
    tilt_correction,
)
from opendrop2.utils.geometry import Rect2
from opendrop2.utils.enums import FittingMethod, RegionSelect, ThresholdSelect

# from opendrop2.utils.keymap import *
...
def set_drop_region(
    ...
    if experimental_setup.drop_id_method == RegionSelect.AUTOMATED:
        from opendrop2.modules.preprocessing.preprocessing import auto_crop
