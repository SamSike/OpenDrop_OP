from opendrop2.modules.core.classes import ExperimentalDrop, ExperimentalSetup, DropData
from opendrop2.modules.image.read_image import get_image
from opendrop2.modules.image.select_regions import (
    set_drop_region,
    set_surface_line,
    correct_tilt,
    # run_set_surface_line
)
from opendrop2.modules.contact_angle.extract_profile import extract_drop_profile
from opendrop2.modules.fitting.fits import perform_fits
from opendrop2.utils.enums import FittingMethod, ThresholdSelect
from opendrop2.utils.config import LEFT_ANGLE, RIGHT_ANGLE
        ...
        for i in range(n_frames):
            ...
            if (
                ...
                if analysis_methods[FittingMethod.ML_MODEL]:
                    ...
                    from opendrop2.modules.ML_model.prepare_experimental import (
                        prepare4model_v03,
                        experimental_pred,
                    )
