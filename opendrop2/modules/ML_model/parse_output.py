...
if generate_plots:  # generate plots using data
    ...
    if show_restart_points == True:
        for i, point in enumerate(restart_points):
            if i == 0:
                plt.plot(
                    [point, point], [min(mae), max(mae)], "r", label="Restart Points"
                )
            else:
    ...
    if show_restart_points == True:
        for i, point in enumerate(restart_points):
            if i == 0:
                plt.plot(
                    [point, point], [min(mse), max(mse)], "r", label="Restart Points"
                )
            else:
    ...
    if show_restart_points == True:
        for i, point in enumerate(restart_points):
            if i == 0:
                plt.plot(
                    [point, point], [min(loss), max(loss)], "r", label="Restart Points"
                )
            else:
