...
def create_model(trial):
    ...
    # trial.suggest_categorical("model_width", [8,16, 32, 64, 128, 256, 512, 1024])
    model_width = 32
    # trial.suggest_int("es_patience", 1024, 1025, log=True)
    es_patience = 1024
...
def main():
    ...
    study.optimize(objective, n_trials=1, timeout=345600)
