...
class Acquisition(CTkFrame):
    def __init__(self, parent, user_input_data: ExperimentalSetup, function_type: FunctionType, **kwargs):
        ...
        image_acquisition_frame.grid(
            row=0, column=0, sticky="new", padx=15, pady=10)
        image_acquisition_frame.grid_columnconfigure(
            1, weight=1)  # Second column (values) can expand
