from opendrop-ml.modules.image.read_image import (
    get_image,
    save_image,
    import_from_source,
    image_from_Flea3,
...
@patch("opendrop-ml.modules.image.read_image.image_from_harddrive")
...
def test_image_from_harddrive(mock_experimental_drop, mock_experimental_setup):
    with patch(
        ...
        image_from_harddrive(mock_experimental_drop,
                             mock_experimental_setup, 0)
...
@patch("opendrop-ml.modules.image.read_image.grabanimage")
