...
if __name__ == "__main__":
    ...
    if "--test" in sys.argv:
        ...
        if result.returncode != 0:
            print("main.exe exited with errors. Outputting last 20 lines of output.log:")
    ...
    run('heat dir dist\\main -cg MainFiles -dr INSTALLFOLDER -gg -g1 -sfrag -srd -sreg -scom -var var.MainDir -out dist/main-files.wxs')
    run('candle -dMainDir=dist\main -o dist/ windows-installer.wxs dist/main-files.wxs')
